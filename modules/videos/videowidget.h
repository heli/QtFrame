...
public:
    ...
    void setDefaultPosX(int x);
    void setDefaultPosY(int y);
    void setDefaultPos(int x, int y);
    int getDefaultPosX();
    int getDefaultPosY();
    void setVideoMax(int max);
    int getVideoMax();
...
public slots:
    ...
    void setFlowButtonText(int idx, QChar txt);
    void resetFlowButton();
    void hideFlowButtons(QList<int> btns);
