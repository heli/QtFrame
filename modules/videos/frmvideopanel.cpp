...
FrmVideoPanel::FrmVideoPanel(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::FrmVideoPanel)
{
    ui->setupUi(this);
...
QSize FrmVideoPanel::sizeHint() const
{
    return QSize(800, 600);
}

QSize FrmVideoPanel::minimumSizeHint() const
{
    return QSize(80, 60);
}

void FrmVideoPanel::initControl()
{
...
void FrmVideoPanel::show_video_25()
{
    videoMax = false;
    QString videoType;
    int index = 0;
...
void FrmVideoPanel::show_video_36()
{
    videoMax = false;
    QString videoType;
    int index = 0;
...
void FrmVideoPanel::show_video_64()
{
    videoMax = false;
    QString videoType;
    int index = 0;
...
void FrmVideoPanel::change_video_25(int index)
{
    hide_video_all();
    change_video(index, 5);
}

void FrmVideoPanel::change_video_36(int index)
{
    hide_video_all();
    change_video(index, 6);
}

void FrmVideoPanel::change_video_64(int index)
{
    hide_video_all();
