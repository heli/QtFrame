...
void FramelessWidget::on_navBtn1_clicked()
{
    emit showContralFrameNav1();
}

void FramelessWidget::on_navBtn2_clicked()
{
    emit showContralFrameNav2();
}

void FramelessWidget::on_navBtn3_clicked()
{
    emit showContralFrameNav3();
}

void FramelessWidget::on_navBtn4_clicked()
{
    emit showContralFrameNav4();
}

void FramelessWidget::on_navBtn5_clicked()
{
    emit showContralFrameNav5();
}
