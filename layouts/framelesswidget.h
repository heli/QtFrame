...
private slots:
    ...
    void on_navBtn1_clicked();

    void on_navBtn2_clicked();

    void on_navBtn3_clicked();

    void on_navBtn4_clicked();

    void on_navBtn5_clicked();


signals:
    // 页面切换
    void showContralFrameNav1();
    void showContralFrameNav2();
    void showContralFrameNav3();
    void showContralFrameNav4();
    void showContralFrameNav5();
